...
const STEPS = [
  {
    ...
    description: 'LTI numbers and transporter details'
  },
  {
    number: 2,
    title: 'Destination Details',
    description: 'Destination and consignee information'
  },
  {
    number: 3,
    title: 'Commodity Information',
    description: 'Commodity details and quantities'
  },
  {
    number: 4,
    title: 'Additional Information',
    description: 'TPO number and remarks'
  }
];
